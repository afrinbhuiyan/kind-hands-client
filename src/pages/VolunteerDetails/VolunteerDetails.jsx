...
import { decrementVolunteersCount, getPostById } from "../../services/api/volunteerDetailsApi";
      ...
      <nav className="flex mb-6" aria-label="Breadcrumb">
        <ol className="inline-flex items-center space-x-1 md:space-x-2">
          <li>
            <Link
              to="/"
              className="inline-flex items-center text-sm font-medium text-gray-700 hover:text-[#024870] dark:text-gray-400 dark:hover:text-white"
            >
              Home
            </Link>
          </li>
          <li>
            <div className="flex items-center">
              ...
              <Link
                to="/volunteers"
                className="ml-2 text-sm font-medium text-gray-700 hover:text-[#024870] dark:text-gray-400 dark:hover:text-white"
              >
                Opportunities
              </Link>
            </div>
              ...
              <motion.button
                ...
                className={`w-full py-4 font-semibold rounded-lg shadow-md flex items-center justify-center space-x-3 transition-all ${
                  post.volunteersNeeded <= 0
                    ...
                    : "bg-gradient-to-r from-[#024870] to-[#6bd3f3] text-white hover:shadow-lg"
                }`}
                whileHover={{
